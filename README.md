...
- [`edit_asset`](pkg/tools/edit_asset/) - Edit an existing asset via a list of typed operations:
    - `update_attribute`, `add_attribute`, `remove_attribute` - change, append, or clear an attribute value (e.g. `Definition`, `Note`); Markdown is converted to HTML for `RICH_TEXT` attributes
