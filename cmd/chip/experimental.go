...
var knownExperimentalFeatures = map[string]string{
	...
	tools.DataQualityFeature:           "Data quality job-run inspection (get_data_quality_job_run_profile, get_data_quality_job_run_monitors) and rule-template authoring (create/update/delete_data_quality_rule_template).",
}
