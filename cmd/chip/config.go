...
func initConfigOptions() {
	...
	pflag.Bool("data-quality", false, "Enable the data quality tools (data quality jobs, rules and rule templates); off by default (env: COLLIBRA_MCP_DATA_QUALITY)")
	_ = viper.BindEnv("mcp.data-quality", "COLLIBRA_MCP_DATA_QUALITY")
	_ = viper.BindPFlag("mcp.data-quality", pflag.Lookup("data-quality"))
	viper.SetDefault("mcp.data-quality", false)
...
ENVIRONMENT VARIABLES:
  ...
  COLLIBRA_MCP_DATA_QUALITY     Enable the data quality tools (default: false)
...
CONFIGURATION FILE EXAMPLE:
  ...
  mcp:
    ...
    data-quality: false  # Optional: register the data quality tools (default: false)
...
type McpConfig struct {
	...
	DataQuality      bool        `mapstructure:"data-quality"`
