...
related: collibra/discovery, collibra/lineage, collibra/asset-create, collibra/asset-edit, collibra/data-product-create, collibra/context, collibra/dq-rules, collibra/dq-rule-workbench, collibra/dq-job-from-data-contract
---
...
| Turn a Data Contract's manifest clauses into an enforcing DQ job and rules (contract-driven monitoring) | `collibra/dq-job-from-data-contract` |
