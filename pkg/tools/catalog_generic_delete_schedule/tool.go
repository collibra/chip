package catalog_generic_delete_schedule
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_generic_delete_schedule",
		Description: "Deletes the synchronization schedule from a GENERIC integration instance.",
