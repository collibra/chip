package list_data_contracts_test
...
func TestListDataContracts(t *testing.T) {
	...
	handler.Handle("/rest/dataProduct/v1/dataContracts", testutil.JsonHandlerOut(func(httpRequest *http.Request) (int, clients.DataContractListPaginated) {
