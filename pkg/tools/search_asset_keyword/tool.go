...
type Output struct {
	...
	Results []Resource `json:"results" jsonschema:"The list of search results"`
}
...
func buildSearchFilters(input Input) []clients.SearchFilter {
...
func mapSearchResponseToOutput(searchResponse *clients.SearchResponse) Output {
	resources := make([]Resource, len(searchResponse.Results))
