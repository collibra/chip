package get_lineage_downstream_test
...
import (
	...
	tools "github.com/collibra/chip/pkg/tools/get_lineage_downstream"
	"github.com/collibra/chip/pkg/tools/testutil"
)

func TestGetLineageDownstream(t *testing.T) {
	handler := http.NewServeMux()
	handler.Handle("/technical_lineage_resource/rest/lineageGraphRead/v1/entities/entity-1/downstream", testutil.JsonHandlerOut(func(r *http.Request) (int, map[string]any) {
	...
	if output.Direction != clients.LineageDirectionDownstream {
...
func TestGetLineageDownstreamNotFound(t *testing.T) {
	handler := http.NewServeMux()
	handler.Handle("/technical_lineage_resource/rest/lineageGraphRead/v1/entities/entity-unknown/downstream", testutil.JsonHandlerOut(func(r *http.Request) (int, string) {
