...
type SearchLineageEntitiesInput struct {
...
func NewSearchLineageEntitiesTool(collibraClient *http.Client) *chip.Tool[SearchLineageEntitiesInput, clients.SearchLineageEntitiesOutput] {
	return &chip.Tool[SearchLineageEntitiesInput, clients.SearchLineageEntitiesOutput]{
		...
		Handler:     handleSearchLineageEntities(collibraClient),
		Permissions: []string{},
	}
}

func handleSearchLineageEntities(collibraClient *http.Client) chip.ToolHandlerFunc[SearchLineageEntitiesInput, clients.SearchLineageEntitiesOutput] {
	return func(ctx context.Context, input SearchLineageEntitiesInput) (clients.SearchLineageEntitiesOutput, error) {
