package catalog_etl_add_schedule
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_etl_add_schedule",
		Description: "Adds a synchronization schedule to an ETL integration. Requires a cron expression and time zone.",
