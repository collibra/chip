package catalog_etl_save_generic_config
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_etl_save_generic_config",
		Description: "Creates or updates the configuration for an ETL integration. The configuration is a JSON string whose schema depends on the integration type. Use catalog_etl_get_schema to discover valid fields.",
