package catalog_etl_delete_generic_config
...
type Input struct {
	IngestibleId string `json:"ingestibleId" jsonschema:"the UUID of the ETL integration whose configuration to delete"`
}
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_etl_delete_generic_config",
		Description: "Deletes the configuration for an ETL integration.",
