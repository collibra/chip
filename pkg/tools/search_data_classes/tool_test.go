package search_data_classes_test
...
func TestFindDataClasses(t *testing.T) {
	...
	handler.Handle("/rest/classification/v1/dataClasses", testutil.JsonHandlerOut(func(httpRequest *http.Request) (int, clients.DataClassesResponse) {
