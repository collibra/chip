package catalog_etl_update_schedule
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_etl_update_schedule",
		Description: "Updates the synchronization schedule for an ETL integration. Creates the schedule if it does not exist.",
