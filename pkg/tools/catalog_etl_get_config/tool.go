package catalog_etl_get_config
...
func NewTool(collibraClient *http.Client) *chip.Tool[Input, Output] {
	return &chip.Tool[Input, Output]{
		Name:        "catalog_etl_get_config",
		Description: "Retrieves the configuration for an ETL integration (e.g. Databricks Unity Catalog, Dataplex). The configuration value is a JSON string specific to the integration type.",
