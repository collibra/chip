...
type Output struct {
	...
	MappingYaml    string    `json:"mappingYaml" jsonschema:"The raw YAML mapping configuration that defines how context is generated. Inspect this to understand which fields and metrics will be collected before passing this specification's ID as contextSpecificationId to get_asset_details."`
