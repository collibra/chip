// Package find_connections implements the find_connections MCP tool: finds Edge
...
// through upload_file's contentBase64) — see create_connection's package doc for the
// guided-manual-creation flow this supports.
package find_connections
